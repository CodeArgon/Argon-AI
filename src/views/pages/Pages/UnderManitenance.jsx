          ...
          <div className="container">
            <div className="maintenance-page">
              <div className="maintenance-bg">
                <img src={maintenancebg01} className="small-bg-one" alt="Img" />
                <img src={maintenancebg02} className="small-bg-two" alt="Img" />
                <img
                  src={maintenancebg03}
              ...
              <div className="maintenance-img text-center">
                <img src={maintenance} className="img-fluid" alt="Img" />
              </div>
