                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="input-block tag-with-img mb-3">
                        ...
                        <TagsInput tags={owner} value={owner} />
                      </div>
                    </div>
                          ...
                          <div className="col-md-12">
                            <div className="input-block mb-3">
                              <div className="d-flex justify-content-between align-items-center">
                                ...
                                <Link
                                  to="#"
                                  className="add-new add-new-deal"
                      ...
                      <div className="col-md-12 contact-add-col">
                        <div className="input-block mb-3">
                          <div className="d-flex justify-content-between align-items-center">
                            ...
                            <Link
                              to="#"
                              className="add-new add-new-contact"
                              onClick={handleAddSelectTwo}
                            >
                              <i className="la la-plus-circle me-2" />
                              Add New
                            </Link>
                      ...
                      <div className="col-md-12 company-add-col">
                        <div className="input-block mb-3">
                          <div className="d-flex justify-content-between align-items-center">
                            ...
                            <Link
                              to="#"
                              className="add-new add-new-company"
                              onClick={handleAddSelectThree}
                            >
                              <i className="la la-plus-circle me-2" />
                              Add New
                            </Link>
